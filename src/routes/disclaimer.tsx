...
export const Route = createFileRoute("/disclaimer")({
  head: () => ({ meta: [{ title: "Disclaimer — VeriSphere AI" }] }),
  component: () => <LegalPage title="Disclaimer" body={<>
    <p>VeriSphere AI is an educational tool that supports critical thinking. It does not replace independent fact-checking, journalism, expert opinion, or human judgment.</p>
