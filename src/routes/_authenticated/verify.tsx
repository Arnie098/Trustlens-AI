  ...
  return (
    <main className="relative mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-16">
      ...
      <p className="mt-3 max-w-xl text-muted-foreground animate-fade-up delay-200">
        Submit a URL, text passage, or image. Images use OCR.space to extract text when possible,
        then you get a transparent TrustScore with evidence and concerns to review.
      </p>
