...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      { title: "Privacy Policy — VeriSphere AI" },
      { name: "description", content: "How VeriSphere AI collects, uses, and protects your data." },
    ],
  }),
  component: () => <LegalPage title="Privacy Policy" body={<>
    ...
    <p>We do not sell your personal data. Aggregate, non-identifying analytics may be used to improve the product. Uploaded images are stored privately and are only accessible to you and, in limited cases, VeriSphere AI administrators for moderation.</p>
  </>} />,
});
