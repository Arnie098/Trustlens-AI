...
export const Route = createFileRoute("/terms")({
  head: () => ({ meta: [{ title: "Terms of Use — VeriSphere AI" }] }),
  component: () => <LegalPage title="Terms of Use" body={<>
    <p>By using VeriSphere AI you agree to use the service lawfully and to treat all AI-generated analysis as guidance, not final judgment. You are responsible for your own decisions to share or act on content.</p>
